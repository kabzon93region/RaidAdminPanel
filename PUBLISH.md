...
git init
git add .
git commit -m "Source backup Raid Admin Panel v1.0.0"
git branch -M main
...
`\\Servant\data\Games\EscapeFromTarkov4\CURSORAIMODING\releases\RaidAdminPanel_v1.0.0_2026-06-26.zip`

```powershell
gh release create v1.0.0 "\\Servant\data\Games\EscapeFromTarkov4\CURSORAIMODING\releases\RaidAdminPanel_v1.0.0_2026-06-26.zip" ^
